...
import { Hash, Send, Smile, Plus, Settings, Mic, Headphones, Volume2, Users, Bell, Pin } from "lucide-react"
...
const initialMessages: Message[] = [
  {
    ...
    content: "Hey everyone! Anyone up for some gaming tonight?",
  ...
  },
  {
    ...
    user: "Sarah Kim",
    avatar: "/placeholder.svg?height=40&width=40",
    content: "I'm in! What game are we thinking?",
  ...
  },
  {
    ...
    user: "Mike Johnson",
    avatar: "/placeholder.svg?height=40&width=40",
    content: "How about some Valorant? I just hit Diamond! 💎",
  ...
  },
  {
    ...
    user: "Emma Davis",
    avatar: "/placeholder.svg?height=40&width=40",
    content: "Congrats Mike! I'll join you guys in a bit, just finishing up some work.",
                ...
                .map((user) => (
                  <div key={user.id} className="flex items-center space-x-2 p-1 rounded hover:bg-gray-600">
                    <div className="relative">
                      ...
                      <div
                        className={`absolute -bottom-1 -right-1 w-3 h-3 rounded-full border-2 border-gray-700 ${getStatusColor(user.status)}`}
                      ></div>
                    </div>
                    <div className="flex-1 min-w-0">
